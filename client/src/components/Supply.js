...
function Supply() {
  ...
  const handleButtonClick = () => {
    window.location.href = "/QRgenerator"; // Replace with the actual URL of the QR Code Generator page
  };
  ...
  return (
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <form onSubmit={handlerSubmitManufacturing}>
        ...
        <button className="btn btn-outline-danger btn-sm" onClick={handleButtonClick}>
      QR-Codes
    </button>
      </form>
      <hr />
